...
<%			
			...
			String qry2 = "update test_record set status='dept_approve' where req_no='"+reqid+"'";
			//out.println("::"+qry2);
...
%>
<center><Strong>List of approved Test Record</strong></center><br><br>
<%			
			try{
			Class.forName("com.mysql.jdbc.Driver"); 
			Connection con3 = DriverManager.getConnection("jdbc:mysql://localhost/test","root","root123"); 
			String qry3 = "select * from test_record where status='dept_approve' and devid='"+username+"' and department=(select department from dept_hod where userid='"+username+"')";
			//out.println("::"+qry3);
...
%>			
			...
			<TH>Forward to IT_Hod</TH>
			</tr>
			<tr>
			<TD> <%= rs.getString("test_name") %> </TD>			
			<TD><a href="dept_test_record_submit.jsp?reqid=<%=req_no%>">Submit</a>
			</td>
			</tr>
			</table>
			<form>
