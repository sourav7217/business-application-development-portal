...
<%			
			...
			String qry2 = "update test_record set status='client_approve' where req_no='"+reqid+"'";
			//out.println("::"+qry2);
...
<%			
			...
			String qry3 = "select * from test_record where status='client_approve' and devid='"+username+"'";
			//out.println("::"+qry3);
...
%>			
			...
			<TH>Forward to Dept_Hod</TH>
			</tr>
			<tr>
			<TD> <%= rs.getString("test_name") %> </TD>			
			<TD><a href="client_test_record_submit.jsp?reqid=<%=req_no%>&username=<%=username%>">Submit</a>
			</td>
			</tr>
			</table>
			<form>
