...
<a href="it_verify_test_record.jsp" class="active">Verify Test Report</a>
<a href="it_verify_sec.jsp">Verify Security Test Report</a>
<a href="it_client_cert.html">Verify Client Certificate</a>
</div>

<div id="box">
<center><h3> View Test Record</h3><br><br>
			<form action="it_view_test_record.jsp">
