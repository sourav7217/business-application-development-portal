...
<a href="dev_srs_submit.jsp"  class="active">Submit SRS for Approval</a>
...
<a href="srs.jsp?username=<%=username%>" class="active">Preview Previous SRS</a>
...
<div id="box"><center>
<a href="it_srs_submit.jsp?username=<%=username%>">Approved SRS</a><br><br><br>
<a href="it_srs_reject.jsp?username=<%=username%>">Rejected SRS</a>
</center>
</div>
</body>
</html>