...
<a href="dev_Upload_Security_Testing.jsp" class="active">Upload Security Testing</a>
...
<a href="sec_test.jsp?username=<%=username%>" class="active">Preview Previous Security Testing</a>
<a href="deploy.jsp?username=<%=username%>">Preview Previous Deployment Form</a>
</div>	
<div id="box"><center><a href="it_sec_submit.jsp?username=<%=username%>">Approved Security Test Report</a><br><br><br>
<a href="it_sec_reject.jsp?username=<%=username%>">Rejected Security Test Report</a></center></div>
</body>
</html>