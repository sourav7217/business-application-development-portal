...
<a href="dev_Upload_Test_Record.jsp" class="active">Upload Test Record</a>
...
<a href="test.jsp?username=<%=username%>" class="active">Preview Previous Test Report</a>
...
<div id="box"><center><a href="it_test_record_submit.jsp?username=<%=username%>">Approved Test Report</a><br><br><br>
<a href="it_test_record_reject.jsp?username=<%=username%>">Rejected Test Report</a></center></div>
</body>
</html>